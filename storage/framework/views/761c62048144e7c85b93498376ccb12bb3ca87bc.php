                  ...
                  <div class="row">
                    <div class="col-12 col-sm-12 col-md-3 col-lg-3">
                        ...
                        <div class=" d-flex justify-content-center">
                          ...
                          background-image: url(<?php echo e(asset($product->feature_image)); ?>);
                          "></div>
                          <form method="POST" id="upload-form-2" action="<?php echo e(route('seller.save.edit.product',$product->id)); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                      ...
                      <div class=" d-flex justify-content-center ">
                        ...
                        <div class="card col-9 col-sm-9 col-md-10 col-lg-10" id="imagePreview" style="
                          ...
                          background-repeat: no-repeat;
                          background-position: center;
                          background-image: url(<?php echo e($product->feature_image == false ? asset('Product/image/product.png') : asset('')); ?>);
                          "></div>
                              ...
                              <div class="form-group">
                                ...
                                <select class="category form-control select_category" disabled  name="select_category" > 
                                  ...
                                  <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option <?php echo e($product->category_id == "$category->id" ? 'selected="selected"' : ''); ?>  value="<?php echo e($category->id); ?>,<?php echo e($category->catalogue); ?>"><?php echo e($category->category); ?> </option>
                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>	
                                </select>
                            ...
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                              <div class="form-group">
                                ...
                                <select class="form-control custm-input" id="ref_country_id" name="country"  >
                                  ...
                                  <option <?php echo e("$country->id" == "$product->country" ? 'selected="selected"' : ''); ?> value="<?php echo e($country->id); ?>"><?php echo e($country->name); ?></option>
                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
...
unset($__errorArgs, $__bag); ?></span> 
                            ...
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                              <div class="form-group">
                                ...
                                <input type="date"  class="start_date form-control " name="start_date"  value="<?php echo e($product->start_at); ?>"/>
...
unset($__errorArgs, $__bag); ?></span>
                      <table id="example1" class="mt-3 table table-bordered table-striped ">
                        <h3><span class="text-danger"> <?php $__errorArgs = ['features[]'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><?php echo e($message); ?><?php unset($message);
...
unset($__errorArgs, $__bag); ?></span> </h3>
                        <thead>
                        <tr>
                          <th>Sr.</th>
                          <th>Name</th>
...
<?php /**PATH /Users/admin/Downloads/Compressed/48_h/resources/views/Seller/body/view-product.blade.php ENDPATH**/ ?>