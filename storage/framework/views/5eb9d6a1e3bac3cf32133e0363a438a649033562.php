		...
		<div class="row">
            ...
            <div class="row justify-content-center">
                <div style="margin-bottom: 20px">
                    <h3 class="text-center font-weight-bold">urgent need ? <br> guaranteed sold within <br> 48 hours at 0% costs <br> no fee, no VAT, no taxes</h3>
                </div>
                <br><br> <br><br>
                ...
                <div class="">
                    <h3 class="text-center font-weight-bold ">for quick and most discrete<br>
                ...
                <div class="col-12 mt-5">
                    <h3></h3>
                    <h1 class="text-center font-weight-bold" style="color:#AD393A">Auction Categories</h1>
                    <h6 class="text-center font-weight-bold" >Always 2 ongoing auctions, one started at midnight <br>
                    ...
                    <div class="row">
                        ...
                        <div class="item col-sm-12 col-md-3" >
                            <div class="httext thirdres">
                                <span><i class="fa fa-users" aria-hidden="true"></i></span>
                                <a style="color:rgb(192,0,0)" title="Total Registered Users">Total Registered Users <br>
...
<?php /**PATH /home/batheuzu/48-h.root4tech.com/resources/views/48-h/body/home.blade.php ENDPATH**/ ?>