                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <a class="btn btn-success" href="<?php echo e(route('admin.change.seller.status',$seller->id)); ?>">Active</a>
                      <?php else: ?>
                      <a class="btn btn-danger" href="<?php echo e(route('admin.change.seller.status',$seller->id)); ?>">Banned</a>
                      <?php endif; ?>
                      </td>
                      <td>
                        <a class="btn btn-info"    href="<?php echo e(route('admin.view.seller',$seller->id)); ?>"><i class="fas fa-eye"></i> | <i class="fas fa-user-edit"></i></a>
                        <a class="btn btn-danger"  href="<?php echo e(route('admin.delete.seller',$seller->id)); ?>"><i class="fas fa-trash-alt"></i></a>
                      </td>
                    </tr>
...
<?php /**PATH /Users/admin/Downloads/Compressed/48_h/resources/views/admins/body/sellers/active-sellers.blade.php ENDPATH**/ ?>