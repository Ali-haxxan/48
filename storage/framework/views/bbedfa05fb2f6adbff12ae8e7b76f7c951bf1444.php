                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                          <a href="<?php echo e(route('user.complete.dispatch.order',$product->id)); ?>">
                            <button class="my-1 btn btn-info"  <?php echo e($product->buyer_completed == 1 ? 'disabled' : ''); ?> <?php echo e($product->is_completed == 0 ? 'disabled' : ''); ?> ><?php echo e($product->buyer_completed == 1 ? 'Item Received' : 'Mark as Received'); ?></button>
                          </a>
                      </td>
                    </tr> 
...
<?php /**PATH /Users/admin/Downloads/Compressed/48_h/resources/views/User/body/dispatch.blade.php ENDPATH**/ ?>