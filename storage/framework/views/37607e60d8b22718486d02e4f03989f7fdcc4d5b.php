          ...
          <div class="col-12">
            <div class="card ">
              ...
              <div class="card-body col-12">
                <form action="<?php echo e(route('admin.create.dispatch.status')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="row">
                ...
                <table id="example1" class="table table-bordered table-striped mt-3">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><?php echo e($i++); ?> </td>
                      <td>
                        <form action="<?php echo e(route('admin.update.dispatch.status',$item->id)); ?>" method="POST" enctype="multipart/form-data">
                          <?php echo csrf_field(); ?>
                        <input class="form-control" type="text" name="status" value="<?php echo e($item->status); ?>">
                      </td>
                      <td>
                        <input class="btn btn-primary" type="submit" value="Update">
                      </form>

                        <a class="btn btn-danger" href="<?php echo e(route('admin.delete.dispatch.status',$item->id)); ?>">
...
<?php /**PATH /Users/admin/Downloads/Compressed/48_h/resources/views/admins/body/manage-status.blade.php ENDPATH**/ ?>