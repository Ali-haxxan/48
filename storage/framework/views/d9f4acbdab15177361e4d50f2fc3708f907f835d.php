          ...
          <div class="col-12">
            <div class="card ">
              <div class="card-header ">
                <h3 class="card-title">Dispatchd Items</h3>
              </div>
              ...
              <div class="card-body col-12">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><?php echo e($i++); ?> </td>
                      <td><a href="<?php echo e(route('admin.view.product',$product->p_id)); ?>" ><?php echo e($product->product_name); ?></a></td>
                      <td><a href="<?php echo e(route('admin.view.product',$product->p_id)); ?>" ><img src="<?php echo e(asset($product->low_qual_img)); ?>" alt="img" ></a></td>
                      <td><a href="<?php echo e(route('admin.view.product',$product->p_id)); ?>" ><?php echo e($product->product_unique_id); ?></a></td>
                      <td><a href="<?php echo e(route('admin.view.user',$product->buyer_id)); ?>" ><?php echo e($product->buyer_username); ?></a></td>
                      <td><?php echo e($product->buyer_email); ?></td>
                      <td><a href="<?php echo e(route('admin.view.seller',$product->seller_id)); ?>" ><?php echo e($product->seller_username); ?></a></td>
                      <td><?php echo e($product->seller_email); ?></td>
...
<?php /**PATH /Users/admin/Downloads/Compressed/48_h/resources/views/admins/body/dispatch.blade.php ENDPATH**/ ?>