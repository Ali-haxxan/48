              ...
              <!-- /.card-header -->
                    ...
                    <div class="col-md-12">
                        <div class="card card-primary mt-5">
                          ...
                          <!-- /.card-header -->
                          <!-- form start -->
                            <form action="<?php echo e(route('seller.updatePassword')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" value="<?php echo e(Auth::guard('seller')->user()->email); ?>" name="email">
...
<?php /**PATH C:\Users\Home PC\Downloads\48h\resources\views/Seller/body/password.blade.php ENDPATH**/ ?>