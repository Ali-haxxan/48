		...
		<div class="row">
			...
			<div class="col-12 col-sm-9 col-md-9 pt-0 pl-md-0 ">
				<div class="left-heading-sec d-flex justify-content-center">
					<h2 class="larg-heading">Yesterday Auction Products </h2>
				</div>
...
<?php echo $__env->make('48-h/footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/admin/Downloads/Compressed/48_h/resources/views/48-h/body/products48.blade.php ENDPATH**/ ?>