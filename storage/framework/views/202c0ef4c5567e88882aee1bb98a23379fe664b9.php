                ...
                <div class="card col-12">
                    ...
                    <div class="row">
                        <div class="mt-3 px-4 col-md-12">
                            <form action="<?php echo e(route('admin.create.feature',$category_id)); ?>" method="post" enctype="multipart/form">
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                    <label for="category"></label>
                                    <div class="form-group col-sm-12 col-md-6">
                                        <input class="form-control " type="text" name="feature" placeholder="Feature Name">
                                        <span class="text-danger"><?php $__errorArgs = ['feature'];
                      ...
                      <table  class="table table-bordered table-striped">
                        ...
                        <?php $__currentLoopData = $features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr>
                            <td><?php echo e($i++); ?> </td>
                            <td>
                                <form action="<?php echo e(route('admin.update.feature',$feature->id)); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <input type="text" class="form-control" name="feature" value="<?php echo e($feature->feature); ?>">
                            </td>
                            <td>
                              <input type="text" class="form-control" name="description" value="<?php echo e($feature->description); ?>">
                            </td>
                            <td>
                              <input type="submit" class="btn btn-primary" value="update">
                            </form>
                              <a class="btn btn-danger"  href="<?php echo e(route('admin.delete.feature',$feature->id)); ?>"><i class="fas fa-trash-alt"></i></a>
                            </td>
                          </tr>
...
<?php /**PATH /Users/admin/Downloads/Compressed/48_h/resources/views/admins/body/features.blade.php ENDPATH**/ ?>