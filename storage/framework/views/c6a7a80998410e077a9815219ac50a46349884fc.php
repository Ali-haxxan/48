                            ...
                            <form action="<?php echo e(route('user.updatePassword')); ?>" method="POST">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" value="<?php echo e(Auth::guard('web')->user()->email); ?>" name="email">
...
<?php /**PATH C:\Users\Home PC\Downloads\48h\resources\views/User/body/password.blade.php ENDPATH**/ ?>