                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a class="my-1 btn btn-info" target="_blank" href="{{url('/chatify',$product->seller_id) }}"><i class="fa fa-comments"></i></a>
                        <a class="my-1 btn btn-info" href="{{route('user.product.seller.info',$product->seller_id) }}">
                          <i class="fa fa-info-circle"></i> seller Info</a>
                        <a class="my-1 btn btn-info" target="_blank" href="{{route('user.review.product',$product->id) }}"><i class="fa fa-eye"></i> View</a>
                          <button class="my-1 btn btn-info ratingbtn" value="{{$product->winn_id}}" type="button" title="Rating" data-toggle="modal" data-target="#BidModal"  {{ $product->rated == null ? '' : 'disabled'}}><i class="fa fa-star"></i> Rating</button>
