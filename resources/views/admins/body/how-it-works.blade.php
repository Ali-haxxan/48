          ...
          <div class="col-md-12">
            <div class="card card-outline card-info">
                  <div class="card-header">
                    <h3 class="card-title">
                      How it's works (Please Use Image Url Only)
                    </h3>
                  </div>
                  ...
                  <div class="card-body col-12">
                    <form action="{{route('admin.update.how.it.works')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id" value="{{$settings->id}}" />
                      <textarea id="summernote" name="summernote" placeholder="Add content here" style="height: 300px">{{$settings->how_it_works}}
                      </textarea>
