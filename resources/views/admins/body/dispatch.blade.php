              ...
              <div class="card-body col-12">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{{$i++}} </td>
                      <td><a href="{{route('admin.view.product',$product->p_id)}}" >{{$product->product_name}}</a></td>
                      <td><a href="{{route('admin.view.product',$product->p_id)}}" ><img src="{{asset($product->low_qual_img)}}" alt="img" ></a></td>
                      <td><a href="{{route('admin.view.product',$product->p_id)}}" >{{$product->product_unique_id}}</a></td>
                      <td><a href="{{route('admin.view.user',$product->buyer_id)  }}" >{{$product->buyer_username}}</a></td>
                      <td>{{$product->buyer_email}}</td>
                      <td><a href="{{route('admin.view.seller',$product->seller_id)  }}" >{{$product->seller_username}}</a></td>
