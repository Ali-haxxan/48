                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <form action="{{route('seller.live.request.product',$product->id)}}" method="POST">
                          @csrf
                        <input class="form-control" type="date" name="start_at" value="{{$product->start_at}}">
                      </td>
                      <td >
                        <a class="btn btn-info"    href="{{route('seller.view.product',$product->id) }}"><i class="fas fa-eye"></i> | <i class="fas fa-edit"></i></a>
