	...
	<div class="container-fluid">
		<div class="row foot-bg" >
			<div class="col-12 col-sm-6 col-md-4 col-lg-2">
				<div class="48-img"><img src="{{asset('logo/'.$settings->logo)}}" alt="48-logo" class="img-fluid"></div>
			...
			<div class="col-6 col-sm-6 col-md-4 col-lg-2">
				<div class="sitemap-box">
					...
					<ul>
							...
							<li><a href="{{url('/Expl-Abbrev')}}">Expl. Abbrev.</a></li>
							<li><a href="{{url('/frequently-ask-questions')}}">FAQ</a></li>
							<li><a href="{{url('/register')}}">Registration</a></li>
							@if (Auth::guard('seller')->user() == true )
							<li><a href="{{url('/seller/home')}}">My 4<sup><b>8</sup>-</b>h account</a></li>
							@else
							<li><a href="{{url('/user/home')}}">My 4<sup><b>8</sup>-</b>h account</a></li>
							@endif
					</ul>
				</div>
			</div>
            <div class="col-6 col-sm-6 col-md-4 col-lg-2">
                <div class="sitemap-box">
                    ...
                    <ul>
                        <li><a target="_blank" href="{{asset('cat_doc/48-h_Numis_Abbrev_eng.pdf')}}"> Numismatic</a></li>
                        <li><a target="_blank" href="{{asset('cat_doc/48-h_Philatelic_abbreviations.pdf')}}">Philatelic</a></li>

                        <li><a target="_blank" href="{{asset('cat_doc/48-h_Miscelanous_Abbrev.pdf')}}">Miscelanous</a></li>
	...
	<div class="row last-footer text-center">
		<div class="col-sm-12 col-md-12 col-lg-12">
			<ul class="footer-link">
											...
											<li><a href="{{url('/copy-right')}}">Copyright Policy</a></li>
											<li><a href="{{url('/Intellectual-Property')}}">Intellectual Property</a></li>
								</ul>
			<p class="last-p"> © {{date("Y").$settings->trademark}} </p>
		</div>
	</div>
</div>
<script>
