			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-12">
                    ...
                    <div class="py-3 mt-2 left-heading-sec d-flex justify-content-center">
                        <a href="{{route('SubProducts.48',$id)}}"><span class="viewallCls">View All Products</span></a>
                    </div>
...
{{--					</div>--}}
				...
				<div class="col-lg-6 col-md-12">
                    ...
                    <div class="py-3 mt-2 left-heading-sec d-flex justify-content-center">
                        <a href="{{route('SubProducts.24',$id)}}"><span class="viewallCls">View All Products</span></a>
                    </div>
{{--					<div class="register-content-sec heightfull">--}}
