	...
	<div class="container">
		<div class="row">
			<div class="col-12 col-sm-12 col-md-12 innerpage-banner">
				<div class="inner-banner-heading">Reset Password</div>
				<ul class="breadcum">
			...
			<div class="col-12 col-sm-12 col-md-12 col-lg-9 pt-0 pl-md-0 ">
				<div class="register-content-sec"> 
					...
					<div class="left-heading-sec">
						<h2 class="larg-heading">Reset Password</h2>
					</div>
							...
							<div class="row">
								<div class="col-12">
									<div class="form-group col-12 col-sm-12 col-md-12 col-lg-9">
										<input class="form-control custm-input" name="email" id="email"value="{{ old('confirm_password')}}" placeholder="User Name (Email Id)" type="email" />
                                        <span class="text-danger"> @error('email'){{$message}}@enderror</span>
									</div>
								</div>
								<div class="col-12 col-sm-12 col-md-12 col-lg-6">
									<div class="form-group col-12 col-sm-12 col-md-12 col-lg-12">
										<input   value="{{old('new_password')}}" placeholder="New Password"  id="password" type="password" class="form-control custm-input @error('password') is-invalid @enderror" name="password" required autocomplete="new-password" />
                                        <span class="text-danger"> @error('password'){{$message}}@enderror</span>
									</div>
								</div>
								<div class="col-12 col-sm-12 col-md-12 col-lg-6">
									<div class="form-group col-12 col-sm-12 col-md-12 col-lg-12">
										<input  value="{{old('confirm_password')}}" placeholder="Confirm Password"  id="password-confirm" type="password" class="form-control custm-input" name="password_confirmation" required autocomplete="new-password"/>
